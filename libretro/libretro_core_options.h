...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   {
      "genesis_plus_gx_turbo_speed_mode",
   ...
   {
      "genesis_plus_gx_turbo_speed_start",
